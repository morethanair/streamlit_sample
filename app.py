...
def main():
    ...
    if choice == "Text Analysis":
        ...
        raw_text = st.text_area("Write something", placeholder="Enter a text in English...",height=300)
    ...
    if choice == "Translation":
        ...
        st.write("")
        st.write("")
        raw_text = st.text_area("Original Text", placeholder="Write something to be translated...", height=200)
        if len(raw_text) < 3:
            st.warning("Please provide a text with at least 3 characters...")
        else:
            target_lang = st.selectbox("Target Language", ["German","Spanish","English","Korean"])
    ...
    if choice == "Sentiment Analysis":
        ...
        st.write("")
        st.write("")
        raw_text = st.text_area("Text to analyze", placeholder="Enter a text here...", height=200)
